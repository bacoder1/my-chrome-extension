import{f as G,g as Z,s as I,r as X,c as J,i as K}from"./resize_image-50o9hnDU.js";const Q={Lycee:"Lycée",Francais:"Français"},ee=e=>{const r=e.split(" ");let o="";for(let t of r)t=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase(),t=Q[t]||t,o=o+" "+t;return o.trim()};function te(e,r){const o=document.querySelector(e);o?r(o):new MutationObserver((n,s)=>{const i=document.querySelector(e);i&&(s.disconnect(),r(i))}).observe(document.body,{childList:!0,subtree:!0})}function oe(e){const r=/(\d{2})\/(\d{2})\/(\d{4})/g;return e.replace(r,(t,n,s,i)=>{const a=new Date(`${i}-${s}-${n}`);return`${n} ${a.toLocaleString("fr-FR",{month:"short"})} ${i}`})}function B(){const e=`
	@font-face {
